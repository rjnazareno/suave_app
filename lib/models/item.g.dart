...
void _itemSerialize(
  ...
  writer.writeBool(offsets[1], object.inCart);
  writer.writeString(offsets[2], object.name);
  writer.writeBool(offsets[3], object.ordered);
...
Item _itemDeserialize(
  ...
  final object = Item(
    id: id,
    inCart: reader.readBool(offsets[1]),
    name: reader.readString(offsets[2]),
    ordered: reader.readBool(offsets[3]),
...
extension ItemQueryFilter on QueryBuilder<Item, Item, QFilterCondition> {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> inCartEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'inCart',
        value: value,
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> orderedEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'ordered',
        value: value,
...
extension ItemQuerySortBy on QueryBuilder<Item, Item, QSortBy> {
  ...
  QueryBuilder<Item, Item, QAfterSortBy> sortByInCart() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'inCart', Sort.asc);
    });
  }

  QueryBuilder<Item, Item, QAfterSortBy> sortByInCartDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'inCart', Sort.desc);
    });
  }
  ...
  QueryBuilder<Item, Item, QAfterSortBy> sortByOrdered() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'ordered', Sort.asc);
    });
  }

  QueryBuilder<Item, Item, QAfterSortBy> sortByOrderedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'ordered', Sort.desc);
    });
  }
...
extension ItemQuerySortThenBy on QueryBuilder<Item, Item, QSortThenBy> {
  ...
  QueryBuilder<Item, Item, QAfterSortBy> thenByInCart() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'inCart', Sort.asc);
    });
  }

  QueryBuilder<Item, Item, QAfterSortBy> thenByInCartDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'inCart', Sort.desc);
    });
  }
  ...
  QueryBuilder<Item, Item, QAfterSortBy> thenByOrdered() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'ordered', Sort.asc);
    });
  }

  QueryBuilder<Item, Item, QAfterSortBy> thenByOrderedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'ordered', Sort.desc);
    });
  }
...
extension ItemQueryWhereDistinct on QueryBuilder<Item, Item, QDistinct> {
  ...
  QueryBuilder<Item, Item, QDistinct> distinctByInCart() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'inCart');
    });
  }
  ...
  QueryBuilder<Item, Item, QDistinct> distinctByOrdered() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'ordered');
    });
  }
...
extension ItemQueryProperty on QueryBuilder<Item, Item, QQueryProperty> {
  ...
  QueryBuilder<Item, bool, QQueryOperations> inCartProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'inCart');
    });
  }
  ...
  QueryBuilder<Item, bool, QQueryOperations> orderedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'ordered');
    });
  }
